...
/**
 * Interface for the Animation Builder, builds a given object.
 *
 * @param <Doc> the type of object which is returned
 */
public interface AnimationBuilder<Doc> {
  ...
  /**
   * Rotates a shape at a given time by a number of degrees.
   *
   * @param name    the name of the shape
   * @param tick    When the shape should be rotated
   * @param degrees the degrees that the shape should be rotated
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Doc> addRotation(String name, int tick, int degrees);
